...
# ModuleNotFoundError: No module named 'altair.vegalite.v4' 오류코드
# pip uninstall altair 뜨면 삭제
# pip install altair==4.2.2 버전 재설치

#실행하기
# streamlit run 파일명( ex)app01_text.py)
